  ...
  public static Angle calculateAbsoluteMotorTurns(
    ...
    double diff =
        (encoder2GearTeeth * normalizedEncoder2Rotations)
            - (encoder1GearTeeth * normalizedEncoder1Rotations);
    ...
    return Rotations.of(km + normalizedEncoder1Rotations);
  }

  /**
   * Calculates the modular multiplicative inverse of 'a' modulo 'm'. Uses the iterative Extended
   * Euclidean Algorithm.
   *
